...
if(diemtong < diemchuan) {
    document.getElementById('choraketqua').innerHTML = "bạn đã rớt do thiếu điểm"+ "điểm của bạn là : " + diemtong;
} else {
    document.getElementById('choraketqua').innerHTML = "bạn đã đậu. tổng diểm" + diemtong;
}
if(diem1 == 0 || diem2 == 0 || diem3 == 0 ) {
    document.getElementById('choraketqua').innerHTML = "bạn đã rớt do có điểm nhỏ hơn không " ;
}
}
...
function thuethunhap() {
        ...
        var n = Number(document.getElementById("thunhapnam").value) - 4e6 - 16e5 * Number(document.getElementById("songuoiphuthuoc").value);
        var t = 0;
        ...
        document.getElementById('tienthuela').innerHTML = "Họ tên: " + e + "; Tiền thuế thu nhập cá nhân: " + formattedTien + " VND";
    }
...
if(chonkhachang =="nhadan") {
    soketnoi.style.display= 'none' ; 
} else if( chonkhachhang =="doanhnghiep") {
    chonkhachhang.style.display = 'block' ; 
} else if(chonkhachhang =='')  { 
alert("vuilong chon khach hang ! ") ; 
}
}
function Tinhtien(){
...
// }
tinhtien = 15 + 75 + (soketnoi > 10 ? (soketnoi - 10) * 5 : 0) + sokenhcaocap * 50;
}
